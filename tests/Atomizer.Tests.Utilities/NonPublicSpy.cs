...
namespace Atomizer.Tests.Utilities
{
    ...
    public static class NonPublicSpy
    {
        ...
        public static Action<TTarget, T1, T2> CreateAction<TTarget, T1, T2>(
            string methodName,
            Type? runtimeType = null
        ) =>
        ...
        public static Func<T1, T2, T3, TResult> CreateStaticFunc<T1, T2, T3, TResult>(
            Type targetType,
            string methodName
        ) =>
        ...
        public static Action<T1, T2> CreateStaticAction<T1, T2>(Type targetType, string methodName) =>
            CreateStaticDelegate<Action<T1, T2>>(
                targetType,
                methodName,
                new[] { typeof(T1), typeof(T2) },
                typeof(void)
        ...
        public static T GetFieldValue<TTarget, T>(
            string fieldName,
            TTarget? instance = default,
            Type? runtimeType = null
        )
